...
const prompts: Prompt[] = [
  { id: 1, title: 'The Strategic Operator', description: 'Turn ambiguous goals into clear, sequenced operating plans with risks, owners, and next moves.', category: 'Strategy', price: '0.08', creator: '0x71...F2a9', creatorName: 'Maya Chen', initials: 'MC', accent: 'coral', preview: 'Name the thing everyone is avoiding. Then make it actionable.', content: 'You are a strategic operator. Take the situation below and return: the uncomfortable truth, the decision that follows, a sequence of three moves, the owner of each move, and the first observable signal that tells us we are on track.' },
  { id: 2, title: 'Socratic Tutor', description: 'A patient learning companion that builds real understanding through well-timed questions.', category: 'Education', price: '0.04', creator: '0x4A...18cE', creatorName: 'Arjun Rao', initials: 'AR', accent: 'blue', preview: 'Do not give me the answer. Help me earn it.', content: 'Act as a Socratic tutor. Never jump to the answer. Ask one question at a time, adapt to the learner\'s last response, identify the misconception underneath a wrong answer, and end with a compact explanation the learner can restate.' },
  { id: 3, title: 'Research Room', description: 'Make dense papers useful: extract claims, challenge assumptions, and surface what matters.', category: 'Research', price: '0.06', creator: '0xB3...92d1', creatorName: 'Nora Ellis', initials: 'NE', accent: 'lilac', preview: 'Make the important parts impossible to miss.', content: 'Read the research below as a skeptical editor. Separate observations from interpretations, extract the strongest claim, list the evidence supporting it, identify the weakest assumption, and propose one follow-up test.' },
  { id: 4, title: 'Brand Voice Kit', description: 'Build a distinct, consistent voice from a handful of examples and a point of view.', category: 'Creative', price: '0.03', creator: '0x19...77b4', creatorName: 'Leo Martins', initials: 'LM', accent: 'mint', preview: 'A recognizable voice is a decision made repeatedly.', content: 'You are a brand voice editor. Infer the point of view, rhythm, vocabulary, and emotional temperature from the examples. Return a concise voice guide, five do and do not pairs, and a rewrite in the established voice.' },
]
