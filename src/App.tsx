...
function App() {
  ...
  return <div className="app-shell">
    ...
    <footer><a className="brand" href="#" onClick={closePrompt}><span className="brand-mark"><Sparkles size={15} /></span><span>prompt<span className="brand-accent">mint</span></span></a><span>Own the prompts that power your agents.</span><span>BOT Chain mainnet · <a href={explorerUrl} target="_blank" rel="noreferrer">Explorer ↗</a></span></footer>
